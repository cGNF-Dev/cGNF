...
def sim(path="", dataset_name="", path_save ="", n_mce_samples = 100000, treatment= '', cat_list=[], moderator =None, quant_mod=4, mediator=None, outcome=None, inv_datafile_name = 'inv'):
